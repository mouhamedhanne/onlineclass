  ...
  return (
    <Container>
      <div className="flex-col items-center justify-center">
        <h2
          className="text-3xl flex justify-center md:text-5xl font-bold pt-5 
            pb-10 bg-gradient-to-r from-[#EDEDA8] to-color_primary bg-clip-text 
            text-transparent"
        >
          Product Features
        </h2>
        ...
        <div className="grid grid-cols-1 p-4 md:grid md:grid-cols-3 gap-4 md:px-40">
          {features.map((feature, index) => (
            <div
              ...
              items-center justify-center w-full hover:scale-105 transform 
            ...
            >
              <div className="text-gray-600 text-3xl font-bold">
                ...
                <div>
                  <div
                    className="text-2xl pb-4 bg-gradient-to-t from-black 
